...
export default function AuthCard({ children, title, subtitle }: AuthCardProps) {
  return (
    <div className="w-full max-w-md animate-scale-in">
      {/* Card */}
      <div className="glass-strong rounded-2xl p-8 shadow-[var(--shadow-lg)]">
        {/* Header */}
  ...
  return (
    <button
      ...
      className="
        ...
        bg-white/[0.03] border border-[var(--border-default)]
        rounded-xl text-sm font-semibold text-[var(--text-primary)]
        hover:bg-white/[0.06] hover:border-[var(--border-hover)]
        active:scale-[0.98]
